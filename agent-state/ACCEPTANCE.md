...
Resume the remaining SEGELF acceptance matrix after the independently reviewed
non-SHF_ALLOC cumulative `R_386_SUB32` repair at
`2f1dc83b8e0e38841f2ea291dff236a3f9265e36`. Preserve the ten accepted linker
regressions and historical repair evidence. Cover malformed relocations,
remaining overflow and retention, and the assembler/writer/parser/linker matrix,
then route any discovered implementation defect to a separate bounded repair.
After SEGELF acceptance, continue the other Gate 1 requirements in roadmap order.
